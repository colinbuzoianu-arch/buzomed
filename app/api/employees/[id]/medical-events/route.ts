...
export async function POST(request: NextRequest, ctx: Ctx) {
  ...
  const event = await prisma.medicalEvent.create({
    data: {
      ...
      ithsReportNumber: body.ithsReportNumber ? String(body.ithsReportNumber).trim() : null,
      injuryDescription: body.injuryDescription ? String(body.injuryDescription).trim() : null,
      daysLost: body.daysLost ? Number(body.daysLost) : null,
