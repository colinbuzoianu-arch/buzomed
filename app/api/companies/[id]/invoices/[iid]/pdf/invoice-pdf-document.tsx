...
const styles = StyleSheet.create({
  ...
  tableHeader: { flexDirection: 'row', backgroundColor: '#f1f5f9', paddingVertical: 6, paddingHorizontal: 8, marginBottom: 0 },
  ...
  vatNotice: { marginTop: 14, fontSize: 7.5, color: '#64748b', backgroundColor: '#f8fafc', paddingVertical: 6, paddingHorizontal: 8, borderRadius: 4 },
  ...
  watermark: { position: 'absolute', top: '40%', left: '15%', fontSize: 72, fontWeight: 700, color: '#fee2e2', opacity: 0.6, letterSpacing: 4 },
