...
export function buildEmployeeFormLabels(t: Translator): EmployeeFormLabels {
  return {
    ...
    fieldDisabilityDegree: t('employees.form.fieldDisabilityDegree'),
    fieldDisabilityDegreeOptions: {
      none: t('employees.form.fieldDisabilityDegreeOptions.none'),
      usor: t('employees.form.fieldDisabilityDegreeOptions.usor'),
      mediu: t('employees.form.fieldDisabilityDegreeOptions.mediu'),
      accentuat: t('employees.form.fieldDisabilityDegreeOptions.accentuat'),
      grav: t('employees.form.fieldDisabilityDegreeOptions.grav'),
    },
