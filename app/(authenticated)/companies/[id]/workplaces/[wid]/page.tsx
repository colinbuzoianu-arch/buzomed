          ...
          {caps.canWriteAdministrative && (
            <BulkAssignEmployees
              ...
              labels={{
                ...
                confirmButtonTransfer: t('workplaces.bulkAssign.confirmButtonTransfer'),
                cancel: t('common.cancel'),
                noResults: t('workplaces.bulkAssign.noResults'),
                searchMinChars: t('workplaces.bulkAssign.searchMinChars'),
                badgeCurrent: t('workplaces.bulkAssign.badgeCurrent'),
                badgeTransferFrom: t('workplaces.bulkAssign.badgeTransferFrom'),
